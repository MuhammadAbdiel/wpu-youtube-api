...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyDVHbf_pu_qPIVGLG58i8i9JnXxZ8RUiPY');
...
$urlLatestVideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyDVHbf_pu_qPIVGLG58i8i9JnXxZ8RUiPY&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet';
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            <a class="navbar-brand" href="#home">Muhammad Abdiel Firjatullah</a>
    ...
    <div class="jumbotron" id="home">
        <div class="container">
            <div class="text-center">
                ...
                <h1 class="display-4">Muhammad Abdiel Firjatullah</h1>
                <h3 class="lead">Content Creator | Software Developer | Entrepreneur</h3>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 text-center">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <h5><?= $youtubeName; ?></h5>
                            <p><?= $youtubeSubscribers; ?> Subscriber</p>
